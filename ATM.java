...
public class ATM{
    ...
    public static void customerLogin(){
        ...
        details.add("Suresh");
        details.add("75000");
        customerDetails.put(987654327,details);
    ...
    public static void withdrawAmount(int creditNumber){
        ...
        int amnt = sc.nextInt();
        if(amnt <= Integer.parseInt(customerDetails.get(creditNumber).get(2))){
        ...
        information.add(String.valueOf(amnt));
        Date dt = new Date();
        information.add(dt.toString());
